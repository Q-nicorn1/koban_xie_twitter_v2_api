...
In retrospect, we would have preferred to create a cloud-hosted MySQL database using Amazon's Relational Database Service (RDS).  However, we created [Docker](https://www.docker.com/) container to locally host a MySQL database.  

To do this, we created an empty directory and added the following Docker .yml file to it:

<img src = "./images/DockerYml.png" width=800px alt="centered image"/>
...
<img src = "./images/ERDiagram.png" width=800px alt="centered image"/>
